...
describe FeedbacksController do
  ...
  let(:valid_attributes) { { "feedback_subject_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved feedback as @feedback" do
        ...
        post :create, {:feedback => { "feedback_subject_id" => "invalid value" }}, valid_session
        assigns(:feedback).should be_a_new(Feedback)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested feedback" do
        ...
        Feedback.any_instance.should_receive(:update).with({ "feedback_subject_id" => "1" })
        put :update, {:id => feedback.to_param, :feedback => { "feedback_subject_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the feedback as @feedback" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Feedback.any_instance.stub(:save).and_return(false)
        put :update, {:id => feedback.to_param, :feedback => { "feedback_subject_id" => "invalid value" }}, valid_session
        assigns(:feedback).should eq(feedback)
      end
